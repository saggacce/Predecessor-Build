...
export const DEFAULT_PERMISSIONS: PlatformPermissions = {
  PLATFORM_ADMIN: {
    ...
    'scrimPlanner.view': true, 'scrimPlanner.create': true, 'scrimPlanner.delete': true,
    ...
    'reviewSessions.view': true, 'reviewSessions.create': true, 'reviewSessions.manage': true,
    'playbook.view': true, 'playbook.create': true, 'playbook.edit': true, 'playbook.delete': true,
    'tacticalBoard.view': true, 'tacticalBoard.save': true,
  ...
  COACH: {
    ...
    'teams.rival.view': true, 'teams.rival.create': true, 'teams.rival.edit': true, 'teams.rival.delete': false,
    'teams.rival.addPlayer': true, 'teams.rival.removePlayer': true, 'teams.rival.syncMatches': true,
    'teamAnalysis.view': true, 'teamAnalysis.performance': true, 'teamAnalysis.draft': true,
    'teamAnalysis.vision': true, 'teamAnalysis.analyst': true,
    ...
    'matchDetail.view': true, 'matchDetail.syncMatch': true, 'matchDetail.editPlayerName': true,
    'matchDetail.scoreboard': true, 'matchDetail.statistics': true, 'matchDetail.timeline': true, 'matchDetail.analysis': true,
    'scrimPlanner.view': true, 'scrimPlanner.create': true, 'scrimPlanner.delete': false,
    'scrimReport.view': true, 'scrimReport.export': true,
    'reviewQueue.view': true, 'reviewQueue.createItem': true, 'reviewQueue.editItem': true, 'reviewQueue.deleteItem': false,
    'reviewSessions.view': true, 'reviewSessions.create': true, 'reviewSessions.manage': true,
    'playbook.view': true, 'playbook.create': true, 'playbook.edit': true, 'playbook.delete': false,
    'tacticalBoard.view': true, 'tacticalBoard.save': true,
  ...
  ANALISTA: {
    ...
    'matchDetail.scoreboard': true, 'matchDetail.statistics': true, 'matchDetail.timeline': true, 'matchDetail.analysis': true,
    'scrimPlanner.view': true, 'scrimPlanner.create': false, 'scrimPlanner.delete': false,
    'scrimReport.view': true, 'scrimReport.export': false,
    'reviewQueue.view': true, 'reviewQueue.createItem': true, 'reviewQueue.editItem': true, 'reviewQueue.deleteItem': false,
    'reviewSessions.view': true, 'reviewSessions.create': false, 'reviewSessions.manage': false,
    'playbook.view': true, 'playbook.create': false, 'playbook.edit': false, 'playbook.delete': false,
    'tacticalBoard.view': true, 'tacticalBoard.save': false,
  ...
  JUGADOR: {
    ...
    'reviewSessions.view': true, 'reviewSessions.create': false, 'reviewSessions.manage': false,
    'playbook.view': true, 'playbook.create': false, 'playbook.edit': false, 'playbook.delete': false,
    'tacticalBoard.view': false, 'tacticalBoard.save': false,
  ...
  PLAYER: {
    ...
    'matchDetail.view': true, 'matchDetail.syncMatch': false, 'matchDetail.editPlayerName': false,
    'matchDetail.scoreboard': true, 'matchDetail.statistics': true, 'matchDetail.timeline': false, 'matchDetail.analysis': false,
    'scrimPlanner.view': false, 'scrimPlanner.create': false, 'scrimPlanner.delete': false,
    'scrimReport.view': false, 'scrimReport.export': false,
    'reviewQueue.view': false, 'reviewQueue.createItem': false, 'reviewQueue.editItem': false, 'reviewQueue.deleteItem': false,
    'reviewSessions.view': false, 'reviewSessions.create': false, 'reviewSessions.manage': false,
    'playbook.view': false, 'playbook.create': false, 'playbook.edit': false, 'playbook.delete': false,
    'tacticalBoard.view': false, 'tacticalBoard.save': false,
    'vodIndex.view': false, 'vodIndex.create': false, 'vodIndex.edit': false, 'vodIndex.delete': false,
    'platformAdmin.view': false, 'platformAdmin.dataControls': false, 'platformAdmin.staff': false,
    'platformAdmin.auditLogs': false, 'platformAdmin.feedback': false, 'platformAdmin.permissions': false,
